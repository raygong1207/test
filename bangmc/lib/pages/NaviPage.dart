...
List<BottomNavigationBarItem> genNaviBarButtonInfoList(Map<String, IconData> infoMap)
{
...
Widget bottomNaviButtonCfg(BuildContext context,_NaviPageState thisClass,int _NaviItemIdx,
                              Map<String, IconData> naviPageName)
{
...
class _NaviPageState extends State<NaviPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // 底部导航栏页面对应按钮名称等的配置
      bottomNavigationBar: bottomNaviButtonCfg(context,this,this._NaviItemIdx,gNaviPageName),
    );
  }
}